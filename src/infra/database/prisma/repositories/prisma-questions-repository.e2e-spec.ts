...
describe('Prisma Questions Repository (E2E)', () => {
  ...
  it('should be able to return cached question details on subsequent calls', async () => {
    const user = await studentFactory.makePrismaStudent()
  ...
  it('should be able to reset question details cache when saving the question', async () => {
    const user = await studentFactory.makePrismaStudent()
